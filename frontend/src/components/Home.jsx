...
//             <h1 className="text-2xl text-orange-500 font-bold">NCource</h1>
//           </div>
//           <div className="space-x-4">
//             <Link to={"/login"}
//              className="bg-transparent text-white py-2 px-4 border border-white rounded">Login</Link>
            
//             <Link to={"/signup"}
//             className="bg-transparent text-white py-2 px-4 border border-white rounded">Signup
//             </Link>
//           </div>
//         </header>

//         <section className="text-center py-20">
//           <h1 className="text-4xl font-semibold text-orange-500">NCourse</h1>
//           <br />
//           <br />
//           <p className="text-grey-500">Welcome to Nitish Course App</p>
//           <div className="space-x-4 mt-8">
//             <button className="bg-green-500 text-white py-3 px-6 rounded font-semibold hover:bg-white duration-300 hover:text-black">Explore course</button>
//             <button className="bg-white text-black py-3 px-3 rounded font-semibold hover:bg-green-500 duration-300 hover:text-white">Course Videos</button>
//           </div>
//         </section>
...
//                 <button className="mt-4 bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-400">Enroll Now</button>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                 </li>
//                 <li className="hover:text-white cursor-pointer duration-300">
//                   instagram- Prajapati_nitish_123
//                 </li>
//                 <li className="hover:text-white cursor-pointer duration-300">
//                   FaceBook- Nitish raj
//                 </li>
      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <p className="text-gray-500">
            Here you can find the best courses to learn programming. By Nitish..
          </p>
          <div className="space-x-4 mt-8">
            <Link
              to={"/courses"}
